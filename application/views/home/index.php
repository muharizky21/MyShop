...
<head>
    ...
    <link href="publik/lib/animate/animate.min.css" rel="stylesheet">
    <link href="publik/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="publik/css/style.css" rel="stylesheet">
    <link href="publik/css/styles.css" rel="stylesheet">
</head>
<body>
    <!-- Topbar Start -->
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a class="navbar-brand" href="#">
                    <img width="250" src="assets/img/logo.png" alt="logo" />
                </a>
            </div>
        ...
        <div class="row px-xl-5 pb-3">
                ...
                <a class="text-decoration-none" href="">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="assets/img/T001.jpeg" alt="">
                        </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="assets/img/J001.jpeg" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Category Name</h6>
                            <small class="text-body">100 Products</small>
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="assets/img/T001.jpeg" alt="">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="assets/img/J001.jpeg" alt="">
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-sync-alt"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-search"></i></a>
    ...
    <script src="publik/lib/easing/easing.min.js"></script>
    <script src="publik/lib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Contact Javascript File -->
    <script src="publik/mail/jqBootstrapValidation.min.js"></script>
    <script src="publik/mail/contact.js"></script>

    <!-- Template Javascript -->
    <script src="publik/js/main.js"></script>
</body>
